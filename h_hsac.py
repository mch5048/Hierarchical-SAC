...
def ecsac(train_indicator, isReal=False,logger_kwargs=dict()):
    ...
    with tf.variable_scope('manager'): # removed desired goal
        ...
        with tf.name_scope('optimize'):
            ...
            train_pi_hi_op = tf.contrib.layers.optimize_loss(
                ...
                increment_global_step=False, clip_gradients=20.0, summaries=("loss", "gradients", "gradient_norm", "global_gradient_norm"), name='pi_hi_opt')
            ...
            with tf.control_dependencies([train_pi_hi_op]): # expreimental application on high-level policy's learning in TD3.
                train_q_hi_op = tf.contrib.layers.optimize_loss(
                    ...
                    increment_global_step=False, clip_gradients=20.0, summaries=("loss", "gradients", "gradient_norm", "global_gradient_norm"), name='q_hi_opt')
    ...
    with tf.variable_scope('controller'):
        ...
        with tf.name_scope('optimize'):
            ...
            train_pi_lo_op = tf.contrib.layers.optimize_loss(
                ...
                increment_global_step=False, clip_gradients=20.0, summaries=("loss", "gradients", "gradient_norm", "global_gradient_norm"), name='pi_lo_opt')
            ...
            with tf.control_dependencies([train_pi_lo_op]): # training pi won't affect learning vf
                ...
                increment_global_step=False, clip_gradients=20.0, summaries=("loss", "gradients", "gradient_norm", "global_gradient_norm"), name='q1_lo_opt')
                ...
                increment_global_step=False, clip_gradients=20.0, summaries=("loss", "gradients", "gradient_norm", "global_gradient_norm"), name='q2_lo_opt')
    ...
    def train_high_level_manager(train_ops, buffer, ep_len=(max_ep_len/manager_propose_freq), batch_size=batch_size, discount=gamma, polyak=polyak, step=0):
        ...
        summary_writer.add_summary(q_hi_outs[-1] , global_step) # low-q summary
